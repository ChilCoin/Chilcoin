...
#if defined(NDEBUG)
# error "Chilcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xd58888d61baa00c7acd6388356e449ca5d54beacab38361fd48cad0012959a2d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Chilcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Chilcoin Signed Message:\n";
...
{
    // Chilcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1051200); // Chilcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // Chilcoin: 3 days
static const int64 nTargetSpacing = 2 * 60; // Chilcoin: 3 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Chilcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Chilcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Chilcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd58888d61baa00c7acd6388356e449ca5d54beacab38361fd48cad0012959a2d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "CL Valparaiso 05/Jun/2014 OGG compila esta moneda para los chilenos";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1402258806;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2349408202;
        ...
        assert(block.hashMerkleRoot == uint256("0xada8ffb09fa491b43296999297d5c2b5583c3e1a7f071f16f12763f943defff4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x4f, 0x41, 0x47, 0x47 }; // Chilcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ChilcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ChilcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ChilcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("chilcoin-miner");
    ...
    try { loop {
        ...
        printf("Running ChilcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ChilcoinMiner terminated\n");
        throw;
    }
}
